...
{
	if (region.ah.M === region.ar.M)
	{
		return 'on line ' + region.ah.M;
	}
	return 'on lines ' + region.ah.M + ' through ' + region.ar.M;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bl, request.J, true);
		} catch (e) {
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{a3: false, a5: r.a5, bd: r.bd, aw: r.aw, bl: r.bl, bI: r.bI, aY: r.aY, J: r.J}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{a5: $elm$http$Http$emptyBody, bd: r.bd, aw: _List_Nil, bl: 'GET', bI: $elm$core$Maybe$Nothing, aY: $elm$core$Maybe$Nothing, J: r.J});
};
	...
	H: {
		...
		j: _List_fromArray(
			[
				...
				j: _List_fromArray(
					[
						{i: true, p: 'outdoors', q: _List_Nil, j: _List_Nil},
						{
						i: true,
						p: 'indoors',
						q: _List_fromArray(
			...
			j: _List_fromArray(
				[
					...
					j: _List_fromArray(
						[
							{i: true, p: 'outdoors', q: _List_Nil, j: _List_Nil},
							{i: true, p: 'indoors', q: _List_Nil, j: _List_Nil}
						])
				}
				])
		},
...
var $author$project$PhotoFolders$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				bd: A2($elm$http$Http$expectJson, $author$project$PhotoFolders$GotInitialModel, $author$project$PhotoFolders$modelDecoder),
...
var $author$project$PhotoFolders$toggleExpanded = F2(
	function (path, _v0) {
		...
		if (!path.$) {
			...
			var subfolders = A2($elm$core$List$indexedMap, transform, folder.j);
			return _Utils_update(
				folder,
				{j: subfolders});
		}
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							H: A2($author$project$PhotoFolders$toggleExpanded, path, model.H)
						}),
...
var $author$project$PhotoFolders$viewFolder = F2(
	function (path, _v0) {
		...
		var folderLabel = A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(folder.p)
				]));
		if (folder.i) {
			var contents = A2(
				$elm$core$List$append,
				A2($elm$core$List$indexedMap, viewSubFolder, folder.j),
				A2($elm$core$List$map, $author$project$PhotoFolders$viewPhoto, folder.q));
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src($author$project$PhotoFolders$urlPrefix + ('photos/' + (photo.J + '/full')))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
...
var $author$project$PhotoFolders$view = function (model) {
	var photoByUrl = function (url) {
		return A2($elm$core$Dict$get, url, model.Z);
	};
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$PhotoFolders$viewFolder, $author$project$PhotoFolders$End, model.H)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$PhotoFolders$main = $elm$browser$Browser$element(
	{
		bk: $author$project$PhotoFolders$init,
		bF: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		bJ: $author$project$PhotoFolders$update,
		bK: $author$project$PhotoFolders$view
	});
